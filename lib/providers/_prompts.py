...
TRIAGE_SYSTEM = (
    ...
    "4. needs_reply: true/false — does the EMAIL CONTENT require the owner to "
    "write back? Be aggressive about flagging needs_reply=true.\n"
    "   TRUE examples: availability requests, interview scheduling, someone asking "
    "a direct question, requests to review/approve something, someone proposing a "
    "meeting time, a recruiter asking for dates, a professor/TA expecting a response, "
    "a friend/colleague asking 'are you coming?', any email that says 'let me know', "
    "'please confirm', 'can you', 'when are you free', 'what do you think'.\n"
    "   FALSE examples: calendar invitations (RSVP is done in calendar not email), "
    "automated notifications, newsletters, marketing, receipts, shipping updates, "
    "FYI-only announcements ('no meeting today'), event invitations that don't ask "
    "a question, group emails where the owner is CC'd with no action item.\n"
    "   When in doubt, set needs_reply=true. It's better to flag too many than miss one.\n"
