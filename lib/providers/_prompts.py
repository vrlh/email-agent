...
TRIAGE_SYSTEM = (
    ...
    "4. needs_reply: true/false — set TRUE if a real person is asking the owner "
    "a question, requesting something, expecting a response, or if ignoring this "
    "email would be rude or harmful. Examples: colleague asking for feedback, "
    "someone scheduling a meeting, a landlord/agent asking for info, a professor "
    "or boss expecting a response. Set FALSE for automated emails, newsletters, "
    "notifications, confirmations, receipts, marketing, shipping updates, job "
    "alerts, and FYI-only messages even if from a real person.\n"
